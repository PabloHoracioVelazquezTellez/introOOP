class Persona:
    def __init__(self, nombre, edad, genero, ocupacion): #<-------------Esto es un constructor
    ...
    #Mandar saludo
    def mandar_saludo(self, otra_persona):
        print(f"Hola {self.nombre}, te manda un saludo {otra_persona.nombre}.")
...
persona1.mandar_saludo(persona3)
